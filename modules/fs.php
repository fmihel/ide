...
require_once UNIT('users.php');


$session = $_REQUEST['session'];
if (!$USERS->autorize($session)) 
	exit;

$path = APP::slash($Application->ROOT,true,true);

$workplace = $USERS->get('workplace','');
$path.= $workplace;
...
if(isset($_GET['operation'])) {
	...
	//$fs = new fs("/home/ubuntu/workspace/ide/modules/");
	$fs = new fs($path);
	//$fs = new fs($Application->ROOT);
	try {
		$rslt = null;
