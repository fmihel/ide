...
WS_CONF::DEF('mode','development');     // режим сборки  production | development | assembly
...
WS_CONF::DEF('assemblyPath','_assembly');   // путь для генерации промежуточной сборки
WS_CONF::DEF('assemblyExclude',[]); // файлы исключенные из промежуточной сборки сборки 
?>